...
class Train():
    ...
    def train(model, mask, field_s, field, n_epoch, gamma, dt, nx, ny, nz, lr, print_interval, arch, pe, epochs_to_order, device, path_fig, path_model, path_output, path_stats):
        ...
        L_p = Physical_Loss(gamma, dt, nx, ny, nz, device)
        L_d = Data_Loss()
